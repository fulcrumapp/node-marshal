...
Marshal = (function () {
  function Marshal (buffer, encoding, suppressErrors) {
    if (buffer !== void 0) this.load(buffer, encoding, suppressErrors);

    return this;
  };

  Marshal.prototype._parse = function (suppressErrors) {
  ...
  Marshal.prototype.load = function (buffer, encoding, suppressErrors) {
    ...
    if (this._index < this.buffer.length) {
      this.parsed = this._parse(suppressErrors);
    }
